# RailsAdmin config file. Generated on December 06, 2013 19:37
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['FIM', 'Admin']
  ...
  # config.excluded_models = ['Comment', 'Follow', 'Like', 'Mention', 'Post', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Comment', 'Follow', 'Like', 'Mention', 'Post', 'User']
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your mention.rb model definition

  #   # Found associations:

  #     configure :mentioner, :polymorphic_association         # Hidden 
  #     configure :mentionable, :polymorphic_association         # Hidden 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :mentioner_type, :string         # Hidden 
  #     configure :mentioner_id, :integer         # Hidden 
  #     configure :mentionable_type, :string         # Hidden 
  #     configure :mentionable_id, :integer         # Hidden 
  #     configure :created_at, :datetime 
